    ...
    return (
      <Person image={require('./img/pril.jpg')}>
        ...
        <ul>
          ...
          <li>В&nbsp;институте разрабатывал антивирусный движок под Linux и&nbsp;занимался темой криптографической защиты информации</li>
          ...
          <li>В&nbsp;Mail.ru был тимлидом проектов Auto.Mail.Ru, Afisha.Mail.Ru, все еще работает в&nbsp;команде Антиспама</li>
          <li>Занимается обучением и&nbsp;консультированием в&nbsp;сфере блокчейн-технологий, разработкой блокчейн-систем на&nbsp;платформе Graphene, аудитом безопасности смарт-контрактов Ethereum</li>
        </ul>
