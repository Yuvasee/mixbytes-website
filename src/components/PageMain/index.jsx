      ...
      <div>
        ...
        <ContainerBlock type="dark">
          <ContentBubble id="company">
            ...
            <p>Мы&nbsp;проводим <a href="/course">курс &laquo;Погружение в&nbsp;блокчейн&raquo;</a>, менторим специалистов, консультируем организации и&nbsp;разрабатываем для них решения.</p>
            <p>Собираем для публикации собственную библиотеку проверенных смарт-контрактов и&nbsp;разрабатываем новый сервис для исследования блокчейнов Bitcoin и&nbsp;Ethereum. Готовим к&nbsp;открытию школу блокчейн-разработчиков.</p>
          </ContentBubble>
          ...
          <ContentBubble id="edu">
            ...
            <p>
              Ближайший уикенд-курс пройдет <strong>9&nbsp;и&nbsp;10&nbsp;сентября.</strong><br />
              <ul>
            ...
            <p>
              В&nbsp;конце года мы&nbsp;запустим большой модульный курс, рассчитанный на&nbsp;программистов. Оставьте ваш e-mail, чтобы первым узнать о&nbsp;старте набора в&nbsp;школу блокчейн-разработчиков:
            </p>
            ...
            <h2>Менторинг</h2>
            <p>Для уверенных в&nbsp;своих силах специалистов. Направим на&nbsp;нужные материалы и&nbsp;практики, поможем в&nbsp;самых трудных местах, проверим результаты. Индивидуальный подход, прием через собеседование. Можно проходить компанией или отделом.</p>
          </ContentBubble>
        </ContainerBlock>
          ...
          <ContentBubble id="team">
            ...
            <Person image={require('./img/yura.jpg')}>
              ...
              <ul>
                ...
                <li>Имеет обширный опыт разработки B2B-решений в&nbsp;сфере интернет-маркетинга и&nbsp;SEO</li>
              </ul>
            </Person>
          </ContentBubble>
        </ContainerBlock>
