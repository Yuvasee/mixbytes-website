      ...
      <div>
        ...
        <ContainerBlock type="dark">
          ...
          <ContentBubble id="edu">
            ...
            <h2>Менторинг</h2>
            <p>Для уверенных в&nbsp;своих силах специалистов. Направим на&nbsp;нужные материалы и&nbsp;практики, поможем в&nbsp;самых трудных местах, проверим результаты. Можно приходить компанией или отделом. Прием через собеседование.</p>
          </ContentBubble>
        </ContainerBlock>
        ...
        <ContainerBlock type="light">
          <ContentBubble id="consult">
            ...
            <p>Ваши знания о&nbsp;блокчейн-технологиях обрывочны, но&nbsp;вы&nbsp;уверены, что эта сфера открывает новые возможности, которые нельзя упускать? Вы&nbsp;можете начать с&nbsp;нашего <a href="/course">публичного курса</a> или обратиться к&nbsp;нам за&nbsp;консультацией.</p>

            <h2>Выбор технических решений, написание ТЗ</h2>
            <p>Подберем стек технологий для решения задачи. Порекомендуем фреймворки, библиотеки, проверенные смарт-контракты. Правильно сформулируем требования для программистов.</p>
